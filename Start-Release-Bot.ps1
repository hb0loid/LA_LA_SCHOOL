...
$env:LALADUB_CHATTERBOX_PYTHON = (Join-Path $Root ".venv-chatterbox\Scripts\python.exe")
$env:LALADUB_CHATTERBOX_MODEL = "v3"
$env:LALADUB_CHATTERBOX_DEVICE = "auto"
$env:LALADUB_CHATTERBOX_CACHE_DIR = (Join-Path $Root "models\chatterbox")
$env:LALADUB_CHATTERBOX_EXAGGERATION = "0.5"
$env:LALADUB_CHATTERBOX_CFG_WEIGHT = "0.5"
$env:LALADUB_CHATTERBOX_TIMEOUT_SECONDS = "1800"
...
$env:LALADUB_ARTIFACT_WHISPER_DEVICE = "cpu"
