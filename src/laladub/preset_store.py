...
PRESET_FIELDS = ("visual_mode", "source_lang", "speaker_count", "target_lang", "tts_provider")
...
def _empty_preset(user_id: int) -> UserPreset:
    return UserPreset(user_id=user_id, visual_mode=None, source_lang=None, speaker_count=None, target_lang=None, tts_provider=None)
